    ...
    <md-table v-model="searched" md-sort="name" md-sort-order="asc">
      ...
      <md-table-row slot="md-table-row" slot-scope="{ item }">
        ...
        <md-table-cell md-label="Actions">
          <md-button to="/transactions" class="md-icon-button ncs-secondary"><md-icon>account_balance_wallet</md-icon></md-button>
          <md-button :to="accountEditLink(item.id)" class="md-icon-button md-primary"><md-icon>edit</md-icon></md-button>
          <md-button :to="accountDeleteLink(item.id)" class="md-icon-button md-accent"><md-icon>delete</md-icon></md-button>
        </md-table-cell>
      </md-table-row>
    </md-table>
  </div>
